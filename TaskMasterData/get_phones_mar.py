...
data_location = '/home/akshatgu/TaskMaster/translated_marathi/'
...
for i, audio in enumerate(files):
    ...
    index = audio.split('.')[0]
    print(index)
    result = subprocess.check_output('python3 -m allosaurus.run --lang mar -i ' + data_location + audio, shell=True)
...
a_file = open("data_taskmaster_marathi.pkl", "wb")
