...
#data_location = '/home/akshatgu/TaskMaster/translated_bengali/'
...
for i, audio in enumerate(files):
    ...
    index = audio.split('.')[0]
    print(index)
    result = subprocess.check_output('python3 -m allosaurus.run --lang eng -i ' + data_location + audio, shell=True)
...
a_file = open("data_taskmaster_english.pkl", "wb")
