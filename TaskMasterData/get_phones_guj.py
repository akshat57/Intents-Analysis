...
data_location = '/home/akshatgu/TaskMaster/translated_gujarati/'
...
for i, audio in enumerate(files):
    ...
    index = audio.split('.')[0]
    print(index)
    result = subprocess.check_output('python3 -m allosaurus.run --lang guj -i ' + data_location + audio, shell=True)
...
a_file = open("data_taskmaster_gujarati.pkl", "wb")
