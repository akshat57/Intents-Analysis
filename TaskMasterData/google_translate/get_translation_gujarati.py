...
file1 = open('taskmaster_gujarati_intent_text.txt','a')
hindi_translation = []
for key in utterances:
    if int(key) >= 0:
        print(key)
        translated_text = translate_text(utterances[key], 'gu')
...
with open('taskmaster_gujarati_intent_text_full.txt', 'w') as filehandle:
