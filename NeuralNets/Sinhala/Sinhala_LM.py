...
for j in range(200):
    ...
    print('split :', split, " train acc: ", acc_cnt/(err_cnt+acc_cnt), " train loss: ", loss_accum / batch_cnt, '--time:', time.time() - start_time)
    ...
    print("validation: ", '--epoch:', j, '--lr:', learn_rate, '--time:', time.time() - start_time)
    print( '--current_acc:', current_acc, '--max', max_acc, '--max_count', max_count,'--max_index', max_index, )
    print('='*30)
