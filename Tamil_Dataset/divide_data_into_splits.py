...
#data = load_data('Tamil_phoneme_transcript.pkl')
data = load_data('/home/akshatgu/SpeechDatasets/Tamil_Dataset/phonemic_transcription/top5/Tamil_phoneme_transcript.pkl')
name_to_intent, intent_freq = read_file('/home/akshatgu/SpeechDatasets/Tamil_Dataset/Tamil_Data.csv')  
...
for i, test_split in enumerate(test_splits):
    ...
    save_data('datasplit_top5_split1/tamil_train_split_' + str(i+1) + '.pkl', train_data)
    save_data('datasplit_top5_split1/tamil_test_split_' + str(i +1) + '.pkl', test_data)
